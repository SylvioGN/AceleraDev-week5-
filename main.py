...
float(round(sct.ttest_ind(usa, can, equal_var=False)[1], 8))
...
def q4():
    log_variable= np.log(get_sample(athletes, 'weight', n=3000, seed=42))
    sct.normaltest(log_variable)
    return False
    pass
